...
const Footer = () => {
  return (
    <>
      <footer className="text-white mt-[14rem] bg-[#ff5f5f] flex flex-col items-center mb-[2rem]">
        <div className=" text-[1rem] lg:text-[1.4rem] bg-gray-100 flex w-[80%] justify-between text-black p-[2.2rem] rounded-[.5rem] mt-[-4.2rem]">
          <div>
            <p>Ready to get started?</p>
            <p>Talk to us today</p>
          </div>
          <button className="uppercase text-white px-4 bg-[#ff5f5f] hover:text-[#ff5f5f]  hover:border-[#ff5f5f] border-2  hover:bg-[#ffffff] text-[1.2rem]">get started</button>
        </div>
        <div className="text-[1rem] font-bold flex flex-col lg:flex-row gap-x-[5rem] mt-[1rem]">
          ...
          <div className="p-[2rem] flex flex-col gap-[1rem]">
            ...
            <input
              ...
              autoComplete="off"
            />
            <button className="text-white px-4 bg-[#ff5f5f] hover:text-[#ff5f5f]  hover:border-[#ff5f5f] border-2  hover:bg-[#ffffff]">Subsribe</button>
          </div>
          <div className="p-[2rem] flex flex-col gap-[1rem]">
            <p>Follow Us</p>
